...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(e,t,n){let r=new Float32Array(Do),i=new q(0,1,0);return new na({name:`SphericalGaussianBlur`,defines:{n:Do,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Wo(),fragmentShader:`
	...
	`}var Go=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};function $l(e,t=1e-4){t=Math.max(t,2**-52);let n={},r=e.getIndex(),i=e.getAttribute(`position`),a=r?r.count:i.count,o=0,s=Object.keys(e.attributes),c={},l={},u=[],d=[`getX`,`getY`,`getZ`,`getW`],f=[`setX`,`setY`,`setZ`,`setW`];for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.attributes[n];c[n]=new r.constructor(new r.array.constructor(r.count*r.itemSize),r.itemSize,r.normalized);let i=e.morphAttributes[n];i&&(l[n]||(l[n]=[]),i.forEach((e,t)=>{let r=new e.array.constructor(e.count*e.itemSize);l[n][t]=new e.constructor(r,e.itemSize,e.normalized)}))}let p=t*.5,m=10**Math.log10(1/t),h=p*m;for(let t=0;t<a;t++){let i=r?r.getX(t):t,a=``;for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.getAttribute(n),o=r.itemSize;for(let e=0;e<o;e++)a+=`${~~(r[d[e]](i)*m+h)},`}if(a in n)u.push(n[a]);else{for(let t=0,n=s.length;t<n;t++){let n=s[t],r=e.getAttribute(n),a=e.morphAttributes[n],u=r.itemSize,p=c[n],m=l[n];for(let e=0;e<u;e++){let t=d[e],n=f[e];if(p[n](o,r[t](i)),a)for(let e=0,r=a.length;e<r;e++)m[e][n](o,a[e][t](i))}}n[a]=o,u.push(o),o++}}let g=e.clone();for(let t in e.attributes){let e=c[t];if(g.setAttribute(t,new e.constructor(e.array.slice(0,o*e.itemSize),e.itemSize,e.normalized)),t in l)for(let e=0;e<l[t].length;e++){let n=l[t][e];g.morphAttributes[t][e]=new n.constructor(n.array.slice(0,o*n.itemSize),n.itemSize,n.normalized)}}return g.setIndex(u),g}Object.freeze({coordinateSystem:`Y-up; local root at (0, 0, 0)`,ownership:`procedural BufferGeometry only; caller owns materials and scene integration`,tree:`nominal height 1, open deciduous canopy radius about 0.35`,fern:`nominal height 1, intended for 0.35-0.65m world scaling`,blade:`nominal length 1, intended for per-instance bending and scaling`});function eu(e){let t=e>>>0||1831565813;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function tu(e){return new X().setHex(e,Re)}function nu(e=!1){let t=[],n=[],r=[],i=[];return{positions:t,colors:n,uvs:r,indices:i,point(i,a,o){return t.push(i.x,i.y,i.z),n.push(a.r,a.g,a.b),e&&r.push(o?.x??0,o?.y??0),t.length/3-1},triangle(e,t,n){i.push(e,t,n)},finish(){let a=new kr;return a.setAttribute(`position`,new _r(t,3)),a.setAttribute(`color`,new _r(n,3)),e&&a.setAttribute(`uv`,new _r(r,2)),a.setIndex(i),a.computeVertexNormals(),a.computeBoundingBox(),a.computeBoundingSphere(),a}}}function ru(e){let t=Math.abs(e.y)>.91?new q(1,0,0):new q(0,1,0),n=new q().crossVectors(e,t).normalize();return{side:n,up:new q().crossVectors(n,e).normalize()}}function iu(e,t,n,r,i,a,o=7){let s=new q().subVectors(n,t),c=s.length();if(c<1e-5)return;s.divideScalar(c);let{side:l,up:u}=ru(s),d=[],f=[];for(let s=0;s<o;s+=1){let c=s/o*Math.PI*2,p=l.clone().multiplyScalar(Math.cos(c)).addScaledVector(u,Math.sin(c));d.push(e.point(t.clone().addScaledVector(p,r),a)),f.push(e.point(n.clone().addScaledVector(p,i),a))}for(let t=0;t<o;t+=1){let n=(t+1)%o;e.triangle(d[t],f[t],f[n]),e.triangle(d[t],f[n],d[n])}}function au(e,t,n,r,i,a){let o=n.clone().normalize(),{side:s,up:c}=ru(o),l=t.clone().addScaledVector(o,-i*.52),u=t.clone().addScaledVector(o,i*.56),d=t.clone().addScaledVector(s,r*.5).addScaledVector(o,-i*.05),f=t.clone().addScaledVector(s,-r*.5).addScaledVector(o,-i*.05),p=t.clone().addScaledVector(c,r*.17),m=e.point(l,a,new K(.5,0)),h=e.point(d,a,new K(0,.48)),g=e.point(u,a,new K(.5,1)),_=e.point(f,a,new K(1,.48)),v=e.point(p,a,new K(.5,.5));e.triangle(m,h,v),e.triangle(h,g,v),e.triangle(g,_,v),e.triangle(_,m,v)}function ou(e=1){let t=eu(e),n=nu(),r=nu(!0),i=[4008733,4796961,5651237].map(tu),a=[3234601,4617266,6260535,7902275].map(tu),o=[new q(0,0,0)];for(let e=1;e<=10;e+=1){let n=o[e-1],r=(t()-.5)*.013*(e/10);o.push(new q(n.x+r,e*.079,n.z+(t()-.5)*.01))}for(let e=0;e<o.length-1;e+=1)iu(n,o[e],o[e+1],.034-e*.00215,.032-e*.00215,i[e%i.length],8);let s=[];for(let e=0;e<25;e+=1){let r=e/25,a=.3+r*.52+t()*.035,c=o[Math.min(9,Math.max(3,Math.round(a/.079)))].clone(),l=e*2.3999632297+t()*.8,u=new q(Math.cos(l),0,Math.sin(l)),d=u.clone().multiplyScalar(.7+t()*.15).add(new q(0,.5+t()*.33,0)).normalize(),f=.0105-r*.0032;for(let r=0;r<4;r+=1){let a=.064-r*.007+t()*.01;d.addScaledVector(u,.08+t()*.05).add(new q((t()-.5)*.15,.02,(t()-.5)*.15)).normalize();let o=c.clone().addScaledVector(d,a);iu(n,c,o,f,f*.7,i[(e+r)%i.length],6),c=o,f*=.7,r>0&&s.push({point:c.clone(),radial:u,direction:d.clone()})}s.push({point:c,radial:u,direction:d});let p=c.clone().addScaledVector(d,.045).add(new q(0,.025,0));iu(n,c,p,f,f*.52,i[e%i.length],5),s.push({point:p,radial:u,direction:d.clone().add(new q(0,.3,0)).normalize()})}for(let e=0;e<2800;e+=1){let n=s[e%s.length],i=t()*Math.PI*2,o=.012+t()**.72*.076,c=new q(Math.cos(i),(t()-.48)*.68,Math.sin(i));au(r,n.point.clone().addScaledVector(n.radial,(t()-.5)*.07).addScaledVector(c,o).add(new q(0,(t()-.44)*.045,0)),c.addScaledVector(n.direction,.55+t()*.25).normalize(),.02+t()*.01,.035+t()*.025,a[(e+Math.floor(t()*2))%a.length])}return{wood:n.finish(),leaves:r.finish()}}function su(e=1){let t=eu(e^2654435769),n=nu(!0),r=[3955235,5601069].map(tu),i=[5078317,6854715,3630119].map(tu);for(let e=0;e<13;e+=1){let a=e/13*Math.PI*2+t()*.28,o=new q(Math.cos(a),0,Math.sin(a)),s=[];for(let e=0;e<=12;e+=1){let n=e/12,r=(.42+t()*.055)*Math.sin(n*Math.PI*.68);s.push(o.clone().multiplyScalar(r).add(new q(0,n*1.08-n*n*.14,0)))}for(let t=0;t<s.length-1;t+=1)iu(n,s[t],s[t+1],.006-t*32e-5,.0057-t*32e-5,r[e%2],5);for(let r=1;r<12;r+=1){let a=r/12,c=new q().subVectors(s[r+1],s[r-1]).normalize(),l=new q().crossVectors(c,o).normalize(),u=(.085+t()*.025)*Math.sin(a*Math.PI*.96);for(let t of[-1,1]){let a=l.clone().multiplyScalar(t*.88).addScaledVector(c,.24).addScaledVector(o,.16).normalize();au(n,s[r].clone().addScaledVector(a,u*.34),a,u*.28,u,i[(r+e+ +(t>0))%i.length])}}}return n.finish()}function cu(){let e=nu(!0),t=tu(5340459),n=[],r=[];for(let i=0;i<=10;i+=1){let a=i/10,o=new q(Math.sin(a*Math.PI*.72)*.16,a,.025*Math.sin(a*Math.PI)),s=.02*(1-a)+.0015,c=t.clone().multiplyScalar(.82+a*.22);n.push(e.point(o.clone().add(new q(0,0,s)),c,new K(0,a))),r.push(e.point(o.clone().add(new q(0,0,-s)),c,new K(1,a)))}for(let t=0;t<10;t+=1)e.triangle(n[t],r[t],r[t+1]),e.triangle(n[t],r[t+1],n[t+1]);return e.finish()}var lu=Math.PI*2,uu=Ot.clamp,du=(e,t,n=0)=>{let r=Math.sin(e*127.1+t*311.7+n*74.7)*43758.5453123;return r-Math.floor(r)};function fu(e,t){let n=new En;n.name=`procedural-natural-environment`,e.add(n);let r=t.size/2,i=new Tn,a=new X,o=new Set,s=new Set,c=new Set,l={value:0},u={value:.2},d=[],f=[],p=!1,m=-1/0,h=-1,g=-1/0,_=``,v=0,y=e=>(o.add(e),e),b=e=>(s.add(e),e);function x(e,n){let i=uu(Math.round((e+r)/t.dx),0,t.n-1);return uu(Math.round((n+r)/t.dx),0,t.n-1)*t.n+i}function S(e,n){let i=uu((e+r)/t.dx,0,t.n-1),a=uu((n+r)/t.dx,0,t.n-1),o=Math.min(Math.floor(i),t.n-2),s=Math.min(Math.floor(a),t.n-2),c=i-o,l=a-s,u=s*t.n+o;return Ot.lerp(Ot.lerp(t.height[u],t.height[u+1],c),Ot.lerp(t.height[u+t.n],t.height[u+t.n+1],c),l)}function C({vertexColors:e=!0,roughness:t=.85,foliage:n=!1,wind:r=!1,rock:i=!1}={}){let a=b(new ia({vertexColors:e,color:16777215,roughness:t,metalness:0,side:n?2:0})),o=e=>{e.uniforms.uNatureTime=l,e.uniforms.uNatureWind=u,e.vertexShader=`uniform float uNatureTime;uniform float uNatureWind;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
        ...
        transformed.z+=bend*cos(uNatureTime*1.1+plantRoot.z*.8)*.018;`)};return a.onBeforeCompile=e=>{r&&o(e),n&&(e.vertexShader=`varying vec2 vLeafUv;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
vLeafUv=uv;`),e.fragmentShader=`varying vec2 vLeafUv;
`+e.fragmentShader,e.fragmentShader=e.fragmentShader.replace(`#include <color_fragment>`,`#include <color_fragment>
          ...
          diffuseColor.rgb*=.94+centre*.14+veins*.055;`)),i&&(e.vertexShader=`varying vec3 vStone;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
vStone=position;`),e.fragmentShader=`varying vec3 vStone;
`+e.fragmentShader,e.fragmentShader=e.fragmentShader.replace(`#include <color_fragment>`,`#include <color_fragment>
          ...
          diffuseColor.rgb*=.72+grain*.42+smoothstep(.75,1.,veins)*.13;`))},a.customProgramCacheKey=()=>`nature-detail-${r}-${i}-${n}`,r&&(a.userData.depth=b(new oa({depthPacking:Le,side:a.side})),a.userData.depth.onBeforeCompile=o,a.userData.depth.customProgramCacheKey=()=>`nature-wind-depth`),a}let w=[3,19,41].map(e=>{let t=ou(e);return y(t.wood),y(t.leaves),t}),T=y(cu()),E=y(su(73)),D=C({roughness:.97,wind:!0}),O=C({roughness:.73,foliage:!0,wind:!0}),k=C({vertexColors:!!T.getAttribute(`color`),roughness:.88,foliage:!0,wind:!0}),A=C({foliage:!0,wind:!0}),j=C({vertexColors:!1,rock:!0,roughness:.79}),ee=C({vertexColors:!1,rock:!0,roughness:.36}),M=new Gi(1,3);M.deleteAttribute(`normal`),M.deleteAttribute(`uv`);let te=y($l(M));M.dispose();let N=te.attributes.position;for(let e=0;e<N.count;e++){let t=N.getX(e),n=N.getY(e),r=N.getZ(e),i=1+.12*Math.sin(t*7+r*5)*Math.cos(n*6-r*4);N.setXYZ(e,t*i,n*i*.68,r*i)}te.computeVertexNormals();function P(e,t,r,i){let a=new ui(e,t,r);return a.name=i,a.castShadow=!0,a.receiveShadow=!0,a.frustumCulled=!1,a.instanceMatrix.setUsage(We),t.userData.depth&&(a.customDepthMaterial=t.userData.depth),n.add(a),a}function ne(e,t,n,r,a,o,s,c=s,l=s){i.position.set(n,r,a),i.rotation.set(0,o,0),i.scale.set(s,c,l),i.updateMatrix(),e.setMatrixAt(t,i.matrix)}function re(){let e=[],n=Math.max(18,Math.min(80,Math.round(t.size*1.7)));for(let i=0;i<1200&&e.length<n;i++){let n=(du(i,9,1)*2-1)*(r-.45),a=(du(i,9,2)*2-1)*(r-.5),o=x(n,a);if(t.water[o]>.008||t.fuel[o]<.45||Math.abs(n)<t.size*.2||a>r*.35&&Math.abs(n)<r*.76||e.some(e=>Math.hypot(e.x-n,e.z-a)<1.3))continue;let s=(a>r*.35?1.8:2.6)+du(i,12,2)*1.1;e.push({x:n,z:a,height:s,yaw:du(i,7,2)*lu,cell:o,base:S(n,a),variant:i%3})}for(let t=0;t<3;t++){let n=e.filter(e=>e.variant===t),r=P(w[t].wood,D,n.length,`tree-trunks-${t}`),i=P(w[t].leaves,O,n.length,`tree-leaves-${t}`);n.forEach((e,t)=>{e.wood=r,e.leaves=i,e.index=t,d.push(e)})}}function ie(){let e=[],n=[];for(let n=0;n<36e3;n++){let i=(du(n,41,1)*2-1)*(r-.035),a=(du(n,41,2)*2-1)*(r-.035),o=x(i,a);if(t.water[o]>.012||t.fuel[o]<.13)continue;let s=.5+.5*Math.sin(i*2.3+Math.cos(a*1.7));du(n,42,1)<.2*(1-s)||e.push({x:i,z:a,cell:o,base:S(i,a),height:.12+du(n,42,2)*.24,yaw:du(n,42,3)*lu,width:.65+du(n,42,4)*.8})}for(let e=0;e<350&&n.length<100;e++){let i=(du(e,51,1)*2-1)*(r-.3),a=(du(e,51,2)*2-1)*(r-.3),o=x(i,a);t.water[o]>.006||t.fuel[o]<.38||Math.abs(i)<t.size*.09||n.some(e=>Math.hypot(e.x-i,e.z-a)<.45)||n.push({x:i,z:a,cell:o,base:S(i,a),height:.28+du(e,53,1)*.38,yaw:du(e,53,2)*lu,width:1})}let i=P(T,k,e.length,`wind-grass`),a=P(E,A,n.length,`riverbank-ferns`);e.forEach((e,t)=>f.push({...e,index:t,mesh:i,fern:!1})),n.forEach((e,t)=>f.push({...e,index:t,mesh:a,fern:!0}))}function ae(){let e=[],n=[];for(let i=0;i<1800;i++){let a=(du(i,63,1)*2-1)*(r-.1),o=(du(i,63,2)*2-1)*(r-.1),s=x(a,o),c=t.water[s]>.005;if(!c&&du(i,63,3)>.22)continue;let l=c?.025+du(i,65,1)*.1:.04+du(i,65,2)**4*.34;(c?n:e).push({x:a,z:o,r:l,y:S(a,o)+l*.18,yaw:du(i,65,3)*lu,tone:du(i,65,4)})}for(let[t,r,i]of[[e,j,`field-stones`],[n,ee,`river-pebbles`]]){let e=P(te,r,t.length,i);t.forEach((t,n)=>{ne(e,n,t.x,t.y,t.z,t.yaw,t.r,t.r,t.r*(.8+t.tone*.4)),a.setHex(t.tone>.6?9799533:t.tone>.28?6450007:4344131),e.setColorAt(n,a)})}}function oe(){let e=[],i=t.n-1;for(let n=0;n<=i;n++)e.push([-r+n/i*t.size,-r]);for(let n=1;n<=i;n++)e.push([r,-r+n/i*t.size]);for(let n=1;n<=i;n++)e.push([r-n/i*t.size,r]);for(let n=1;n<=i;n++)e.push([-r,r-n/i*t.size]);let a=Math.min(...e.map(e=>S(...e)))-.35;[3752234,4339498,3157027].forEach((t,r)=>{let i=[],o=[];e.forEach(([e,t],n)=>{let s=S(e,t);if(i.push(e,Ot.lerp(s,a,r/3),t,e,Ot.lerp(s,a,(r+1)/3),t),n){let e=(n-1)*2,t=n*2;o.push(e,t,e+1,e+1,t,t+1)}});let s=new kr;s.setAttribute(`position`,new _r(i,3)),s.setIndex(o),s.computeVertexNormals(),c.add(s);let l=new Qr(s,b(new ia({color:t,roughness:1})));l.name=`exposed-stratified-earth-${r}`,l.castShadow=l.receiveShadow=!0,n.add(l)})}function se(e=!1){let n=d.map(e=>{let n=uu(t.fuel[e.cell]/.55,0,1)*(1-t.fire[e.cell]);return{x:e.x,z:e.z,base:e.base+e.height*.36,top:e.base+e.height*1.06,radius:e.height*.36,opacity:n*.63}}),r=n.map(e=>e.opacity.toFixed(1)).join(`,`);(e||r!==_)&&(t.setCanopies?.(n,++v),_=r)}function ce(e,n={},r=!1){if(p||(l.value=e,u.value=uu((n.wind??2)/3,0,2),t.revision!==h&&F(),(e<g||e-g>=1)&&(se(),g=e),e>=m&&e-m<.2))return;m=e;let i=new Set;d.forEach(e=>{let n=uu(t.fuel[e.cell]/.55,0,1)*(1-t.fire[e.cell]);e.lastLive!==n&&(e.lastLive=n,i.add(e.wood),i.add(e.leaves),ne(e.wood,e.index,e.x,e.base,e.z,e.yaw,e.height),ne(e.leaves,e.index,e.x,e.base,e.z,e.yaw,n>.06?e.height:0),e.wood.setColorAt(e.index,a.setRGB(.6+n*.4,.5+n*.5,.4+n*.6)),e.leaves.setColorAt(e.index,a.setRGB(.22+n*.78,.13+n*.87,.075+n*.925)))}),f.forEach(e=>{let n=uu(t.fuel[e.cell]/.4,0,1)*(1-t.fire[e.cell]),r=t.water[e.cell]<(e.fern?.04:.025)&&n>.04,o=r?n:-1;if(e.visualKey===o)return;e.visualKey=o,i.add(e.mesh);let s=r?e.height*(.4+n*.6):0;if(ne(e.mesh,e.index,e.x,e.base-.008,e.z,e.yaw,s*e.width,s,s),e.fern)a.setRGB(.58+n*.42,.5+n*.5,.3+n*.7);else{let t=.72+e.width*.24;a.setRGB(t,t,t*.9),n<.8&&a.multiplyScalar(.2+n*.8)}e.mesh.setColorAt(e.index,a)}),i.forEach(e=>{e.instanceMatrix.needsUpdate=!0,e.instanceColor&&(e.instanceColor.needsUpdate=!0)})}function F(){p||(n.children.forEach(e=>{e.isInstancedMesh?e.dispose():e.name.startsWith(`exposed-stratified-earth-`)&&(s.delete(e.material),e.material.dispose())}),n.clear(),c.forEach(e=>e.dispose()),c.clear(),d=[],f=[],re(),ie(),ae(),oe(),h=t.revision,m=-1/0,se(!0),ce(t.time,t.settings))}function le(){p||(p=!0,n.children.forEach(e=>{e.isInstancedMesh&&e.dispose()}),n.clear(),e.remove(n),o.forEach(e=>e.dispose()),c.forEach(e=>e.dispose()),s.forEach(e=>e.dispose()),d=[],f=[])}return F(),{update:ce,rebuild:F,dispose:le}}function pu(e){let t=new Fn,n=e.material.clone(),r=new Qr(e.geometry,n);return r.matrixAutoUpdate=!1,t.add(r),{capture(i,a){e.updateWorldMatrix(!0,!1),r.matrix.copy(e.matrixWorld),r.visible=e.visible;let o=$i.clone(e.material.uniforms);for(let[e,t]of Object.entries(o))n.uniforms[e].value=t.value;return n.uniforms.showSunDisc.value=0,n.uniformsNeedUpdate=!0,t.background=a,i.fromScene(t,.04,.1,1200)},dispose(){t.clear(),n.dispose()}}}var mu=Ot.clamp,hu=`
...
`;function gu(e,t){let n=[1517674,1342356,7646567,15713364,14966823,16777215],r=mu((e-12)/140,0,1)*5;return t.setHex(n[Math.floor(r)]),r<5&&t.lerp(new X(n[Math.floor(r)+1]),r%1),t}function _u(r,i,{onSample:a,onBrush:o,onError:s}={}){let c=new kl({canvas:r,antialias:!0,alpha:!1,powerPreference:`high-performance`});c.debug.onShaderError=()=>{s?.(`この端末で水や炎を描画できませんでした。ブラウザを更新して再度開いてください。`)},c.setPixelRatio(Math.min(devicePixelRatio||1,2.5)),c.shadowMap.enabled=!0,c.shadowMap.type=1,c.toneMapping=4,c.toneMappingExposure=.95,c.outputColorSpace=Re;let l=new Fn,{n:u,size:d}=i,f=d*.5,p=new q(d*.65,d*.68,d*.82),m=new q(0,.35,-d*.035);l.environmentIntensity=.08,l.background=new X(11455443),l.fog=new Pn(11455443,.009);let h=new La(42,1,.1,1800),g=new Ba(-f,f,f,-f,.1,1800);h.position.copy(p),g.position.set(0,d*2.2,.001);let _=h,v=new zl(_,r);v.target.copy(m),v.enableDamping=!0,v.dampingFactor=.09,v.minDistance=d*.16,v.maxDistance=d*2.4,v.minZoom=.7,v.maxZoom=5,v.maxPolarAngle=Math.PI*.47,v.minPolarAngle=.15,v.screenSpacePanning=!0,v.touches.ONE=n.ROTATE,v.touches.TWO=n.DOLLY_PAN,v.update();let y=new Ql;y.scale.setScalar(1e3),y.material.uniforms.turbidity.value=3.2,y.material.uniforms.rayleigh.value=2.1,y.material.uniforms.mieCoefficient.value=.006,y.material.uniforms.mieDirectionalG.value=.82,l.add(y);let b=new Ta(13100543,4669736,1.2);l.add(b);let x=new Ha(16773328,3.2);x.castShadow=!0,x.shadow.mapSize.set(4096,4096),Object.assign(x.shadow.camera,{left:-d*.7,right:d*.7,top:d*.7,bottom:-d*.7,near:1,far:130}),x.shadow.camera.updateProjectionMatrix(),x.shadow.bias=-15e-5,x.shadow.normalBias=.012,x.shadow.radius=2,x.target.position.set(0,0,0),l.add(x,x.target);let S=new Io(c);S.compileCubemapShader();let C=pu(y),w=null,T=``,E=new q,D=new Ki(d,d,u-1,u-1);D.rotateX(-Math.PI/2);let O=new Float32Array(u*u*3);D.setAttribute(`color`,new mr(O,3));let k=new ia({vertexColors:!0,roughness:.95,metalness:0});k.onBeforeCompile=e=>{e.vertexShader=`varying vec3 vTerrainPosition;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
vTerrainPosition=position;`),e.fragmentShader=`varying vec3 vTerrainPosition;
`+hu+e.fragmentShader,e.fragmentShader=e.fragmentShader.replace(`#include <color_fragment>`,`#include <color_fragment>
      ...
      diffuseColor.rgb=mix(diffuseColor.rgb,vec3(.28,.23,.15),grit*.28);`),e.fragmentShader=e.fragmentShader.replace(`#include <normal_fragment_maps>`,`#include <normal_fragment_maps>
      float soilGrain=fbm(vTerrainPosition*36.);
      normal=normalize(normal+vec3(dFdx(soilGrain),dFdy(soilGrain),0.)*.32);`)};let A=new Qr(D,k);A.receiveShadow=!0,A.castShadow=!0,l.add(A);let j=new Ki(d,d,u-1,u-1);j.rotateX(-Math.PI/2),j.setAttribute(`waterDepth`,new mr(new Float32Array(u*u),1)),j.setAttribute(`waterFlow`,new mr(new Float32Array(u*u*2),2)),j.setAttribute(`waterHeat`,new mr(new Float32Array(u*u),1));let ee={uTime:{value:0},uThermal:{value:0}},M=new aa({color:3186092,roughness:.18,metalness:0,transmission:.55,thickness:.22,ior:1.333,clearcoat:1,clearcoatRoughness:.08,transparent:!0,opacity:.88,side:2,depthWrite:!1,envMapIntensity:1.1});M.onBeforeCompile=e=>{Object.assign(e.uniforms,ee),e.vertexShader=`attribute float waterDepth;attribute vec2 waterFlow;attribute float waterHeat;varying float vHeat;varying float vDepth;varying vec2 vFlow;varying vec3 vWaterPosition;uniform float uTime;
`+e.vertexShader,e.vertexShader=e.vertexShader.replace(`#include <begin_vertex>`,`#include <begin_vertex>
      ...
      normal=normalize(normal+vec3(sin(q.x*9.+q.y*5.+uTime*2.)*.065,cos(q.y*8.-q.x*3.+uTime)*.065,0.));`)};let te=new Qr(j,M);te.receiveShadow=!0,te.renderOrder=2,te.frustumCulled=!1,l.add(te);let N=fu(l,i),P=u*u,ne=new Ki(1,1);ne.translate(0,.5,0),ne.setAttribute(`strength`,new ni(new Float32Array(P),1)),ne.setAttribute(`seed`,new ni(new Float32Array(P).map((e,t)=>t*.618034%1),1));let re={uTime:{value:0},uWind:{value:new K},uCellWidth:{value:i.dx*2.4},uFlameHeight:{value:i.landscape===`creek`?1.15:2.2}},ie=new ui(ne,new na({uniforms:re,transparent:!0,depthWrite:!1,blending:1,side:2,vertexShader:`attribute float strength;attribute float seed;varying vec2 vUv;varying float vStrength;varying float vSeed;uniform vec2 uWind;uniform float uCellWidth;uniform float uFlameHeight;
      ...
      gl_Position=projectionMatrix*(center+vec4(offset,0.));}`,fragmentShader:`varying vec2 vUv;varying float vStrength;varying float vSeed;uniform float uTime;${hu}
      ...
      #include <tonemapping_fragment>
      #include <colorspace_fragment>
      }`}),P);ie.instanceMatrix.setUsage(We),ie.count=0,ie.frustumCulled=!1,ie.renderOrder=4,l.add(ie);let ae=Array.from({length:6},(e,t)=>{let n=new za(16738337,0,9,2);return n.castShadow=!1,t<2&&(n.shadow.mapSize.set(512,512),n.shadow.normalBias=.08,n.shadow.autoUpdate=!1),l.add(n),n}),oe=2200,se=new Float32Array(oe*3),ce=new Float32Array(oe).fill(100),F=new Float32Array(oe),le=new Float32Array(oe),ue=new Float32Array(oe),de=new Float32Array(oe),fe=new kr;fe.setAttribute(`position`,new mr(se,3)),fe.setAttribute(`size`,new mr(ue,1)),fe.setAttribute(`alpha`,new mr(de,1));let pe=new na({transparent:!0,depthWrite:!1,uniforms:{uScale:{value:500},uLight:{value:.7},uOrtho:{value:0}},vertexShader:`attribute float size;attribute float alpha;varying float vAlpha;uniform float uScale;uniform float uOrtho;
      void main(){vAlpha=alpha;vec4 p=modelViewMatrix*vec4(position,1.);gl_Position=projectionMatrix*p;gl_PointSize=clamp(size*uScale/mix(max(1.,-p.z),40.,uOrtho),1.,180.);}`,fragmentShader:`varying float vAlpha;uniform float uLight;void main(){vec2 p=gl_PointCoord*2.-1.;float d=dot(p,p);if(d>1.||vAlpha<.001)discard;float a=pow(1.-d,2.)*vAlpha;gl_FragColor=vec4(vec3(.19+.38*uLight),a);}`}),me=new Li(fe,pe);me.frustumCulled=!1,me.renderOrder=5,l.add(me);let he=0,ge=0,_e=1800,I=new Float32Array(_e*6);for(let e=0;e<_e;e++)I[e*6]=Math.random()*d-d/2,I[e*6+1]=Math.random()*20,I[e*6+2]=Math.random()*d-d/2;let ve=new kr;ve.setAttribute(`position`,new mr(I,3));let ye=new ji(ve,new yi({color:13231343,transparent:!0,opacity:.25,depthWrite:!1}));ye.frustumCulled=!1,ye.renderOrder=6,l.add(ye);let be=new Qr(new qi(.97,1,64),new Br({color:15201734,transparent:!0,opacity:.8,depthTest:!1,side:2}));be.rotation.x=-Math.PI/2,be.renderOrder=10,be.visible=!1,l.add(be);let xe=`3d`,Se=`look`,Ce=1.2,we=!1,Te=!1,Ee=!1,De=-1,Oe=0,ke=0,Ae=0,je=new oo,L=new K,Me=new Map,R=!1,Ne=null,z=0,Pe=new X,B=new X(6652988),V=new X(2432023),Fe=new X(5004096),Ie=new Tn,Le=[],ze=[],Be=0,Ve=0,He=-1;function Ue(){v.enabled=!0,v.enableRotate=xe===`3d`&&Se===`look`,v.touches.ONE=Se===`look`&&xe===`2d`?n.PAN:n.ROTATE,v.mouseButtons.LEFT=Se===`look`&&xe===`2d`?t.PAN:t.ROTATE}function Ge(e){let t=r.getBoundingClientRect();L.set((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1),je.setFromCamera(L,_);let n=je.intersectObject(A,!1)[0];return n?n.point:null}function Ke(e){let t=Ge(e);return be.visible=!!t&&Se!==`look`,t&&(be.position.set(t.x,t.y+.075,t.z),be.scale.setScalar(Ce),a?.(i.sample(t.x,t.z))),t}function qe(e){if(Me.set(e.pointerId,{x:e.clientX,y:e.clientY}),Me.size>1){R=!1,Ne=null;return}let t=Ke(e);Se!==`look`&&t&&e.button===0&&(R=!0,Ne=t,z=0,r.setPointerCapture(e.pointerId),i.brush(Se,t.x,t.z,Ce,1),o?.(Se))}function Je(e){let t=Ke(e);R&&Me.size===1&&t&&(Ne=t)}function Ye(e){Me.delete(e.pointerId),R=!1,Ne=null,r.hasPointerCapture(e.pointerId)&&r.releasePointerCapture(e.pointerId),Ue(),Me.size||(be.visible=!1)}let Xe=e=>{e.preventDefault(),Ee=!0,s?.(`描画を再開するには、世界を開き直してください。`)};r.addEventListener(`pointerdown`,qe,!0),r.addEventListener(`pointermove`,Je),r.addEventListener(`pointerup`,Ye),r.addEventListener(`pointercancel`,Ye),r.addEventListener(`webglcontextlost`,Xe);function Ze(){let{width:e,height:t}=r.getBoundingClientRect();if(!e||!t||e===ke&&t===Ae)return;ke=e,Ae=t,c.setSize(e,t,!1),h.aspect=e/t,h.updateProjectionMatrix();let n=e/t,i=n<1?d*.56/n:d*.62;g.left=-i*n,g.right=i*n,g.top=i,g.bottom=-i,g.updateProjectionMatrix(),pe.uniforms.uScale.value=t*c.getPixelRatio()}function Qe(){let{hour:t,sunPower:n,rain:r}=i.settings,a=`${t}:${n}:${r}`;if(T===a)return;T=a;let o=e(i.settings);E.fromArray(o.direction),y.material.uniforms.sunPosition.value.copy(E).multiplyScalar(200);let s=Math.max(0,o.daylight),c=mu(r/100,0,.8);x.position.copy(E).multiplyScalar(60),x.intensity=(s>0?3.8:0)*o.irradianceMultiplier,x.color.setHSL(.11-(1-s)*.07,.16+(1-s)*.45,.92),b.intensity=.12+s*1.6*(1-c*.35);let u=new X().setHSL(.55+(1-s)*.03,.18,.07+s*.62-c*.12);l.fog.color.copy(u),l.background.copy(u),pe.uniforms.uLight.value=s,y.visible=s>.015;let d=C.capture(S,u);l.environment=d.texture,w?.dispose(),w=d}function $e(){let e=D.attributes.position.array,t=j.attributes.position.array,n=j.attributes.waterDepth.array,r=j.attributes.waterHeat.array,a=j.attributes.waterFlow.array;Le.length=0,ze.length=0,Be=0;for(let o=0;o<u*u;o++){let s=o*3,c=i.height[o],l=i.water[o];if(e[s+1]=c,t[s+1]=c+Math.max(0,l)+.008,n[o]=l,r[o]=i.waterTemperature[o],a[o*2]=i.flowX[o],a[o*2+1]=i.flowZ[o],we)gu(i.temperature[o],Pe);else{let e=mu(i.fuel[o]/2,0,1),t=i.moisture[o],n=Math.abs(i.height[Math.min(o+1,u*u-1)]-c)/i.dx;Pe.setHex(n>1.15?7567219:7759949),Pe.lerp(B,e*.9),Pe.multiplyScalar(1-t*.16),(i.fire[o]>.01||i.fuel[o]<.09&&i.temperature[o]>70)&&Pe.lerp(V,.85),l>.004&&Pe.lerp(Fe,.35)}Pe.toArray(O,s),i.fire[o]>.008&&(Le.push(o),Be+=i.burnRate[o]*i.dx**2/(.012*.4**2),ze.push(Be))}D.attributes.color.needsUpdate=!0,De!==i.revision&&(D.attributes.position.needsUpdate=!0,D.computeVertexNormals(),D.computeBoundingSphere(),De!==-1&&N.rebuild(),De=i.revision,He=i.vegetationRevision),He!==i.vegetationRevision&&(N.rebuild(),He=i.vegetationRevision),j.attributes.position.needsUpdate=!0,j.attributes.waterDepth.needsUpdate=!0,j.attributes.waterFlow.needsUpdate=!0,j.attributes.waterHeat.needsUpdate=!0,Oe%3==0&&j.computeVertexNormals();for(let t=0;t<Le.length;t++){let n=Le[t];Ie.position.set(e[n*3],e[n*3+1]+.02,e[n*3+2]),Ie.updateMatrix(),ie.setMatrixAt(t,Ie.matrix),ne.attributes.strength.array[t]=i.fire[n]}if(ie.count=Le.length,ie.instanceMatrix.needsUpdate=!0,ne.attributes.strength.needsUpdate=!0,Oe===1||Oe%8==0){let t=[...Le].sort((e,t)=>i.burnRate[t]-i.burnRate[e]),n=[];for(let r of t){let t=e[r*3],i=e[r*3+2];if(n.every(n=>Math.hypot(t-e[n*3],i-e[n*3+2])>2)&&n.push(r),n.length===ae.length)break}ae.forEach((t,r)=>{let a=n[r];if(a===void 0){t.intensity=0,t.castShadow=!1,t.shadow.needsUpdate=!1;return}t.position.set(e[a*3],e[a*3+1]+.8,e[a*3+2]),t.intensity=i.burnRate[a]*18e3,t.castShadow=r<2,t.shadow.needsUpdate=t.castShadow})}}function H(e){let t=i.settings.windAngle*Math.PI/180,n=Math.cos(t)*i.settings.wind,r=Math.sin(t)*i.settings.wind;re.uWind.value.set(n,r),ge=Math.min(ge+Be*e*12,200);let a=Math.min(100,Math.floor(ge));for(ge-=a;a-- >0&&Le.length;){let e=Math.random()*Be,t=0,n=ze.length-1;for(;t<n;){let r=t+n>>1;ze[r]<e?t=r+1:n=r}let r=Le[t],a=he++%oe,o=a*3;se[o]=r%u*i.dx-d/2+(Math.random()-.5)*.3,se[o+1]=i.height[r]+.5+i.fire[r],se[o+2]=Math.floor(r/u)*i.dx-d/2+(Math.random()-.5)*.3,ce[a]=0,F[a]=5+Math.random()*5,le[a]=i.fire[r]}for(let t=0;t<oe;t++){if(ce[t]+=e,ce[t]>=F[t]){de[t]=0;continue}let i=t*3,a=ce[t],o=F[t];se[i]+=(n*.45+Math.sin(t+a*1.7)*.3)*e,se[i+1]+=(.4+le[t]*1.1)*Math.exp(-a*.08)*e,se[i+2]+=(r*.45+Math.cos(t*.8+a)*.3)*e,ue[t]=.35+a*.36,de[t]=Math.min(1,a*2)*(1-a/o)*.2}for(let e of Object.values(fe.attributes))e.needsUpdate=!0;let o=Math.floor(_e*mu(i.settings.rain/70,0,1));ve.setDrawRange(0,o*2);for(let t=0;t<o;t++){let i=t*6;I[i]+=n*e*.6,I[i+1]-=e*12,I[i+2]+=r*e*.6,(I[i+1]<0||Math.abs(I[i])>d/2||Math.abs(I[i+2])>d/2)&&(I[i]=Math.random()*d-d/2,I[i+1]=17+Math.random()*5,I[i+2]=Math.random()*d-d/2),I[i+3]=I[i]-n*.025,I[i+4]=I[i+1]+.45,I[i+5]=I[i+2]-r*.025}ve.attributes.position.needsUpdate=!0}return{render(e=0,t=e){if(!(Te||Ee)){if(i.time<Ve&&(ce.fill(100),de.fill(0),ge=0,Ne=null,R=!1),Ve=i.time,Oe++,Ze(),Qe(),R&&Ne&&Me.size===1)for(z+=Math.min(t,.1);z>=.1;)i.brush(Se,Ne.x,Ne.z,Ce,.35),z-=.1;$e(),ee.uTime.value=i.time,re.uTime.value=i.time,H(e),N.update(i.time,i.settings,we),v.update(),c.render(l,_)}},setMode(e){xe=e,_=xe===`2d`?g:h,v.object=_,Ue(),xe===`2d`?(g.position.set(0,d*2.2,.001),v.target.copy(m),g.zoom=1,g.updateProjectionMatrix()):v.target.copy(m),pe.uniforms.uOrtho.value=+(xe===`2d`),ke=0,Ze(),v.update()},setTool(e,t=Ce){Se=e,Ce=t,be.visible=!1,R=!1,Ne=null,Ue()},setThermal(e){we=e,ee.uThermal.value=+!!e,M.transmission=e?0:.55,M.opacity=e?1:.88,M.needsUpdate=!0},resetCamera(){h.position.copy(p),g.position.set(0,d*2.2,.001),g.zoom=1,g.updateProjectionMatrix(),v.target.copy(m),v.update()},dispose(){if(Te)return;Te=!0,r.removeEventListener(`pointerdown`,qe,!0),r.removeEventListener(`pointermove`,Je),r.removeEventListener(`pointerup`,Ye),r.removeEventListener(`pointercancel`,Ye),r.removeEventListener(`webglcontextlost`,Xe),v.dispose(),N.dispose();let e=new Set,t=new Set;l.traverse(n=>{if(n.geometry&&e.add(n.geometry),n.material)for(let e of Array.isArray(n.material)?n.material:[n.material])t.add(e)}),e.forEach(e=>e.dispose()),t.forEach(e=>e.dispose()),w?.dispose(),C.dispose(),S.dispose(),x.shadow.dispose(),ae.forEach(e=>e.shadow.dispose()),c.dispose(),c.forceContextLoss()}}}export{_u as createNatureView};